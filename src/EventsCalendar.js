export const getEvents = () => {
    return [
        ...
        { title: "EXAMEN: Grafica M", allDay: true, start: new Date(2022, 0, 28), end: new Date(2022, 0, 28) },
        { title: "EXAMEN: AyC M", allDay: true, start: new Date(2022, 0, 27), end: new Date(2022, 0, 27) },
        { title: "EXAMEN: Web T", allDay: true, start: new Date(2022, 0, 27), end: new Date(2022, 0, 27) },
        { title: "Presentar y enseñar motor T", allDay: true, start: new Date(2022, 0, 25), end: new Date(2022, 0, 25) },
        { title: "EXAMEN: Legislacion T", allDay: true, start: new Date(2022, 0, 21), end: new Date(2022, 0, 21) },
        { title: "Presentar interfaz telefono M", allDay: true, start: new Date(2022, 0, 20), end: new Date(2022, 0, 20) },
        { title: "EXAMEN: Software M", allDay: true, start: new Date(2022, 0, 19), end: new Date(2022, 0, 19) },
        { title: "Trabajo legislacion", allDay: true, start: new Date(2022, 0, 17), end: new Date(2022, 0, 17) },
        { title: "Trabajo interfaz telefono", allDay: true, start: new Date(2022, 0, 16), end: new Date(2022, 0, 16) },
        { title: "Presentar Web individual", allDay: true, start: new Date(2022, 0, 17), end: new Date(2022, 0, 19) },
        { title: "Entregar Web individual", allDay: true, start: new Date(2022, 0, 17), end: new Date(2022, 0, 17) },
        { title: "Trabajo computer graphics", allDay: true, start: new Date(2022, 0, 9), end: new Date(2022, 0, 9) },
